...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = File.createTempFile("D:\\Восстановлено\\java\\JavaRushTasks\\2.JavaCore\\src\\com\\javarush\\task\\task20\\task2001\\test", null);
    ...
    public static class Human {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            name = br.readLine();
            int assetSize = Integer.parseInt(br.readLine());
