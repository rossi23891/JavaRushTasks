                ...
                return stock1.get("name").toString().compareTo(stock2.get("name").toString());
                    ...
                    public int compare(Stock stock1, Stock stock2) {
                        if(stock1.containsKey("open")){
                            st1 = (double)stock1.get("last")-(double)stock1.get("open");
                        }else{
                            st1 = (double)stock1.get("change");
                        }
                        if(stock2.containsKey("open")){
                            st2 = (double)stock2.get("last")-(double)stock2.get("open");
                        }else{
                            st2 = (double)stock2.get("change");
                        }
